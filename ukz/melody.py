...
class Melody:
    ...
    def contracted(self,factor):
        return self.stretched(Fraction(1,factor))
    ...
    def repeat(self,times):
        ...
        return self
    def divided(self,f):
      return self.repeated(f).stretchedTo(1)
