...
#abassmi = MidiInstrument(33,2,[90]*8)
#abassi = Instrument()
#abassi.setDefault([abassmi])

# (82,100,36) was good too
# (48,60,36) was good too
# (33,90,24) was good too.
# not sustained though but good
# (58,100,24) was kind of good
#actualbass = song.addTrack(33)
#actualbass.curVolume = 90
#actualbass.setPitchShift(24)
#actualbass = song.addTrack(abassi)
actualbass = song.addTrack(\
	Instrument({"": [\
	#MidiInstrument(44,3,[60]*8)\
	MidiInstrument(33,2,[90]*8)\
	]}))
...
bass = song.addTrack(\
	Instrument({"":\
	[MidiInstrument(4,3,[100]*8),\
	MidiInstrument(5,3,[100]*8)\
	]}))
...
#rain = song.addTrack(rainprog)
#rain.curVolume = 100
#rain.setPitchShift(72)
rain = song.addTrack(\
	Instrument({"": [\
	MidiInstrument(4,6,[110]*8),\
	#MidiInstrument(4,7,[110]*8),\
	MidiInstrument(2,6,[90]*8)\
...
# ok (44,85,60) is good!
#choir = song.addTrack(44)
#choir.curVolume = 80
#choir.setPitchShift(60)
choir = song.addTrack(\
	Instrument({"":\
	[MidiInstrument(44,5,[80]*8)\
	#MidiInstrument(52,4,[80]*8)\
	]}))
...
def playActualBass(pitches,playAll=False):
    ...
    for pind in pis:
        ...
        p = pitches[pind]
        dur = value(durv)
        actualbass.addNote(p,dur)
        actualbass.forward(dur)
...
print('Song written!')
print('  Title:',officialName)
print('  Length:',\
	float(songLength),'seconds')
